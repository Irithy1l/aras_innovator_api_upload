...
#     import json
#
#     url = 'http://47.96.66.12/InnovatorServer/server/odata/CAD(\'011817173F5641CE8416B8456679E7CD\')'
#     headers = {'Authorization': f'Bearer {generate_token.generate('admin', 'innovator')}'}
#
#     # url = 'http://47.96.66.12/InnovatorServer/server/odata/File(\'6391BD466ADC4B548874C4E47E480899\')'
#     body = {
#         'native_file@odata.bind': f'File(\'C9F8962E066044808BB03660C0D2E53E\')'
#     }
#
